...
const Cart = () => {
  ...
  const cartItems = (cartItem) => {
    return (
      <div className="px-4 my-5 bg-neutral-100 rounded-t-md" key={cartItem.id}>
        <div className="py-4 relative">
          ...
          <div className="flex justify-center">
            <div className="w-1/3">
              <img src={cartItem.image} alt={cartItem.name} height="200px" />
            </div>
            <div className="w-1/3">
              <h3 className="text-3xl mb-5">{cartItem.name}</h3>
              <p className="font-bold text-2xl">$ {cartItem.price}</p>
            </div>
          </div>
        </div>
      </div>
  ...
  const emptyCart = () => {
    return (
      <div className="px-4 my-5 bg-slate-100 rounded-md py-5">
        <div className="py-4">
  ...
  const checkout = () => {
    return (
      <div className="flex flex-col px-5 md:px-7 pt-2 pb-5 md:pb-7">
        <a
          className="w-full px-5 py-3 md:py-4 flex items-center justify-center bg-heading rounded-md text-sm sm:text-base text-white focus:outline-none transition duration-300 cursor-not-allowed bg-gray-400 hover:bg-gray-400"
          href="/"
        >
